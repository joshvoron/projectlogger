...
class ProjectLogger:
    ...
    def new_logger(self, name, color=None) -> logging.Logger:
        """
    ...
    def new_child(self, parent: logging.Logger, name: str, color: str | None = None) -> logging.Logger:
        """
    ...
    def set_colors_from_json(self, file_path: str):
        ...
        try:
            ...
            logging.critical("JSON loading error: No such file or directory")
